            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="template-demo">
                  ...
                  <button type="button" className="btn btn-outline-light text-black btn-fw">Light</button>
              ...
              <div className="card-body">
                ...
                <p className="card-description">Use any of the available button classes to quickly create a styled
                  button.</p>
                <div className="template-demo">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="template-demo">
                  <button type="button" className="btn btn-gradient-info btn-lg btn-block">Block buttons <i
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="card-description">Wrap icon and text inside <code>.btn-icon-text</code> and
                      use <code>.btn-icon-prepend</code> or <code>.btn-icon-append</code> for icon tags</p>
                    <div className="template-demo">
                      ...
                      <button type="button" className="btn btn-gradient-dark btn-icon-text"> Edit <i
                    ...
                    <div className="template-demo">
                      ...
                      <button type="button" className="btn btn-gradient-info btn-icon-text"> Print <i
                    ...
                    <div className="template-demo mt-2">
                      ...
                      <button type="button" className="btn btn-outline-secondary btn-icon-text"> Edit <i
                        className="mdi mdi-file-check btn-icon-append"></i>
                      </button>
                    ...
                    <div className="template-demo">
                      ...
                      <button type="button" className="btn btn-outline-info btn-icon-text"> Print <i
                        className="mdi mdi-printer btn-icon-append"></i>
                      </button>
              ...
              <div className="card-body">
                ...
                <div className="template-demo">
                  <button type="button" className="btn btn-social-icon btn-facebook"><i
                    className="mdi mdi-facebook"></i></button>
                  <button type="button" className="btn btn-social-icon btn-youtube"><i className="mdi mdi-youtube"></i>
                  </button>
                  <button type="button" className="btn btn-social-icon btn-twitter"><i className="mdi mdi-twitter"></i>
                  </button>
