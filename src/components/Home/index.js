                    ...
                    <div className="d-flex mt-5 align-items-top">
                      <img src="/assets/images/faces/face3.jpg" className="img-sm rounded-circle mr-3" alt="image"/>
                        <div className="mb-0 flex-grow">
                          ...
                          <p className="mb-0 font-weight-light">It is a long established fact that a reader will be
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-success" role="progressbar" style={{width: "25%"}}
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-danger" role="progressbar" style={{width: "75%"}}
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-warning" role="progressbar" style={{width: "90%"}}
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-primary" role="progressbar" style={{width: "50%"}}
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-danger" role="progressbar" style={{width: "35%"}}
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="progress">
                              <div className="progress-bar bg-gradient-info" role="progressbar" style={{width: "65%"}}
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="add-items d-flex">
                      ...
                      <button className="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                              id="add-task">Add
                      </button>
                    </div>
